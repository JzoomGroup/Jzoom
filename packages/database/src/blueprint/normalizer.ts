  ...
  const settings: NormalizedBlueprint["settings"] = [
    {
      ...
      reason: "PR18 Admin-configurable platform settings foundation",
      sortOrder: 0,
    },
    {
    ...
    },
    {
      ...
      isSensitive: false,
      value: "yyyy-MM-dd",
      reason: "PR18 date display preference foundation",
      sortOrder: 3,
    },
    {
      ...
      valueType: "JSON",
      isSensitive: false,
      value: { locale: "ar-SA", numberingSystem: "latn", currencyDisplay: "symbol" },
      reason: "PR18 number display preference foundation",
      sortOrder: 4,
    },
    {
    ...
    },
    {
      ...
      isSensitive: false,
      value: "#FF5A4D",
      reason: "PR18 configurable Jzoom brand color foundation",
      sortOrder: 8,
    },
    {
      key: "branding.colors",
      ...
      reason: "PR18 configurable brand identity foundation",
      sortOrder: 9,
    },
    {
      key: "branding.logo_metadata",
      category: "branding",
      valueType: "JSON",
      isSensitive: false,
      value: { fileId: null, storageKey: null, altText: "Jzoom" },
      reason: "PR18 logo metadata reference placeholder without file workflows",
      sortOrder: 10,
    },
    {
      key: "branding.pdf_display_name",
      category: "branding",
      valueType: "STRING",
      isSensitive: false,
      value: "Jzoom",
      reason: "PR18 configurable PDF display name",
      sortOrder: 11,
    },
    {
      key: "business_text.quote_terms",
      category: "business_text",
      valueType: "JSON",
      isSensitive: false,
      value: {
        ar: "تخضع الخدمات للشروط المتفق عليها في العرض.",
        en: "Services are subject to the terms agreed in the quote.",
      },
      reason: "PR18 Admin-configurable quote terms foundation",
      sortOrder: 12,
    },
    {
      key: "business_text.invoice_terms",
      category: "business_text",
      valueType: "JSON",
      isSensitive: false,
      value: {
        ar: "يرجى مراجعة الفاتورة مع فريق جازوم عند الحاجة.",
        en: "Please coordinate with the Jzoom team for invoice questions.",
      },
      reason: "PR18 Admin-configurable invoice terms foundation",
      sortOrder: 13,
    },
    {
      key: "business_text.request_instructions",
      category: "business_text",
      valueType: "JSON",
      isSensitive: false,
      value: {
        ar: "يرجى تزويد فريق التنفيذ بالمعلومات المطلوبة للطلب.",
        en: "Please provide the required information for the service request.",
      },
      reason: "PR18 Admin-configurable request instruction foundation",
      sortOrder: 14,
    },
    {
      key: "business_text.client_document_request",
      category: "business_text",
      valueType: "JSON",
      isSensitive: false,
      value: {
        ar: "يرجى رفع المستند المطلوب عبر البوابة.",
        en: "Please upload the requested document through the portal.",
      },
      reason: "PR18 Admin-configurable client document request text foundation",
      sortOrder: 15,
    },
    {
      key: "business_text.output_delivery_note",
      category: "business_text",
      valueType: "JSON",
      isSensitive: false,
      value: {
        ar: "تمت مشاركة المخرج للمراجعة.",
        en: "The output has been shared for review.",
      },
      reason: "PR18 Admin-configurable output delivery note foundation",
      sortOrder: 16,
    },
    {
