...
export const oneTimeServiceManagerCopy = {
  ar: {
    ...
    exportError: "تعذر تصدير كتالوج خدمات المرة الواحدة.",
    exportSuccess: "تم تجهيز ملف التصدير الكامل.",
    exporting: "جاري التصدير...",
    estimatedHours: "الساعات المقدرة",
    hours: "الساعات",
    inactive: "غير نشط",
    importCatalog: "استيراد خدمات",
    importError:
  ...
  en: {
    ...
    exportError: "The one-time service catalog could not be exported.",
    exportSuccess: "The complete export file is ready.",
    exporting: "Exporting...",
    estimatedHours: "Estimated hours",
    hours: "Hours",
    inactive: "Inactive",
    importCatalog: "Import services",
    importError: "Import failed. Use a Jzoom export file and verify categories and service codes.",
    importing: "Validating and importing...",
    importSuccess: (count: number) =>
      `Import completed. The catalog now contains ${count} services.`,
    initialStatus: "Initial status",
    internalHourlyCost: "Internal hourly cost (SAR)",
...
export const pricingRuleManagerCopy = {
  ar: {
    ...
    formula: "معادلة",
    formulaOrRule: "وصف القاعدة أو المعادلة التوثيقية",
    formulaRules: "قواعد توثيقية",
    ...
    ruleEngineEntries: "محفوظة للتوثيق ولا تنفذ حسابيًا",
    rules: "القواعد",
  ...
  en: {
    ...
    formula: "Formula",
    formulaOrRule: "Rule description or documentation formula",
    formulaRules: "Documentation rules",
    ...
    ruleEngineEntries: "Stored for documentation and not executed",
    rules: "Rules",
...
export const pricingStudioCopy = {
  ar: {
    ...
    chooseServices: "اختر خدمات العرض",
    chooseServicesDescription:
      "ابحث في الكتالوج واختر الخدمات المطلوبة، ثم اضبط الباقة والكمية لكل خدمة.",
    ...
    deleteDraftBlockedHint:
      "إذا كانت المسودة مرتبطة بعرض سعر فسيتم منع الحذف حفاظًا على السجل التجاري.",
    deleteDraftDescription:
      "سيتم حذف المسودة وجميع بنودها نهائيًا. لا يمكن التراجع عن هذا الإجراء.",
    deleteDraftEyebrow: "إدارة المسودة",
    deleteDraftTitle: "حذف مسودة التسعير",
    deletingDraft: "جاري الحذف...",
    confirmDeleteDraft: "حذف المسودة نهائيًا",
    draftTitle: "عنوان المسودة",
    draftValue: "قيمة المسودة",
    draftLibraryDescription: "اختر مسودة محفوظة للمتابعة أو ابدأ مسودة جديدة.",
    duration: "المدة",
    ...
    monthlyServicesTab: "الخدمات الشهرية",
    newDraft: "جديد",
    newPricingDraft: "مسودة تسعير جديدة",
    noDrafts: "لا توجد مسودات تسعير حتى الآن.",
    noDraftsDescription: "ابدأ مسودة جديدة، اختر العميل والخدمات، ثم احفظها للمتابعة لاحقًا.",
    ...
    noMatchingServicesDescription: "غيّر عبارة البحث أو التصنيف، أو ألغِ خيار إظهار المحدد فقط.",
    noPackages: "لا توجد باقات مفعلة لهذه الخدمة. راجع إعدادات الخدمة قبل إضافتها.",
    oneTime: "مرة واحدة",
    oneTimeServices: "3. خدمات المرة الواحدة",
    oneTimeServicesDescription: "اختر خدمات البناء والخدمات الرقمية المفعلة من الكتالوج.",
    oneTimeServicesTab: "خدمات المرة الواحدة",
    package: "الباقة",
    packageQuantity: "عدد الباقات",
  ...
  en: {
    ...
    backendPreview: "Pricing preview",
    ...
    chooseServices: "Choose quote services",
    chooseServicesDescription:
      "Search the catalog, select the required services, then set each package and quantity.",
    ...
    deleteDraftBlockedHint:
      "Deletion is blocked when the draft is linked to a quote, preserving the commercial record.",
    deleteDraftDescription:
      "This permanently deletes the draft and all of its items. This action cannot be undone.",
    deleteDraftEyebrow: "Draft management",
    deleteDraftTitle: "Delete pricing draft",
    deletingDraft: "Deleting...",
    confirmDeleteDraft: "Delete draft permanently",
    draftTitle: "Draft title",
    draftValue: "Draft value",
    draftLibraryDescription: "Choose a saved draft to continue or start a new one.",
    duration: "Duration",
    ...
    monthlyServicesTab: "Monthly services",
    newDraft: "New",
    newPricingDraft: "New pricing draft",
    noDrafts: "No pricing drafts yet.",
    noDraftsDescription:
      "Start a new draft, select the client and services, then save it for later.",
    ...
    noMatchingServicesDescription:
      "Change the search or category, or turn off the selected-only filter.",
    noPackages: "This service has no active packages. Review its setup before adding it.",
    oneTime: "One-time",
    ...
    oneTimeServicesTab: "One-time services",
    package: "Package",
    ...
    searchServicesPlaceholder: "Search by service name or code...",
    sector: "Sector",
