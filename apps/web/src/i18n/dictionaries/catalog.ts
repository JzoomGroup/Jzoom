...
export const pricingStudioCopy = {
  ar: {
    ...
    quoteNeedsSave: "احفظ التغييرات الحالية قبل إصدار العرض.",
    ...
    type: "النوع",
    showDrafts: "عرض المسودات المحفوظة",
  ...
  en: {
    ...
    quoteNeedsSave: "Save the current changes before issuing a quote.",
