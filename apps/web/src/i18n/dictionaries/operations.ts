export const accountManagerPortfolioCopy = {
  ar: {
    ...
    city: "المدينة",
    clientsActivity: "العملاء والنشاط",
    ...
    pageDescription:
      "مركز محفظة يوضح العملاء المسندين، الاستخدام، الأعمال المفتوحة والنشاط الأخير.",
  ...
  en: {
    ...
    city: "City",
    clientsActivity: "Clients and activity",
    ...
    pageDescription:
      "Assigned clients, open work, usage, and recent activity from current operating data.",
