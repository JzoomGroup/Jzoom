...
export function eventLabel(eventCode: string, locale: SupportedLocale): string {
  const labels: Record<string, Record<SupportedLocale, string>> = {
    ...
    CLIENT_PROJECT_VIEWED: { ar: "عرض مشروع العميل", en: "Client project viewed" },
    CLIENT_REQUEST_VIEWED: { ar: "عرض طلب العميل", en: "Client request viewed" },
    ...
    HOURS_LEDGER_USAGE_SUMMARY_VIEWED: {
      ar: "عرض ملخص استخدام سجل الساعات",
      en: "Hours ledger usage summary viewed",
    },
    ...
    PROJECT_OUTPUT_CREATED: { ar: "إنشاء مخرج مشروع", en: "Project output created" },
    PROJECT_OUTPUT_FILE_UPLOADED: {
      ar: "رفع ملف مخرج مشروع",
      en: "Project output file uploaded",
    },
    PROJECT_OUTPUT_STATUS_CHANGED: {
      ar: "تغيير حالة مخرج مشروع",
      en: "Project output status changed",
    },
    QUOTE_ACCEPTED: { ar: "قبول عرض سعر", en: "Quote accepted" },
    QUOTE_ACTIVATED: { ar: "تفعيل عرض سعر", en: "Quote activated" },
    QUOTE_APPROVED: { ar: "اعتماد عرض سعر", en: "Quote approved" },
    ...
    QUOTE_PAYMENT_CONFIRMED: { ar: "تأكيد دفع عرض سعر", en: "Quote payment confirmed" },
